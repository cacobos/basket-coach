...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'sessions/new', redirectTo: '/sessions', pathMatch: 'full' },
      ...
      { path: 'sessions/:id/attendance', loadComponent: () => import('./features/sessions/session-attendance.component').then(m => m.SessionAttendanceComponent) },

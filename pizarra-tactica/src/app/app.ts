...
import { CanvasService, EditorState } from './services/canvas.service';
import { Playbook, Player, PlayerType } from './models/player.model';
...
export class App implements AfterViewInit, OnDestroy {
  ...
  async exportAllPDF(): Promise<void> {
    ...
    for (let i = 0; i < steps.length; i++) {
      ...
      // Court image + legend side by side
